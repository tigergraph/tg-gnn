...
wget https://developer.download.nvidia.com/compute/cuda/12.9.1/local_installers/cuda-repo-ubuntu${ubuntu_version}-12-9-local_12.9.1-575.57.08-1_amd64.deb
sudo dpkg -i cuda-repo-ubuntu${ubuntu_version}-12-9-local_12.9.1-575.57.08-1_amd64.deb
sudo cp /var/cuda-repo-ubuntu${ubuntu_version}-12-9-local/cuda-*-keyring.gpg /usr/share/keyrings/
sudo apt-get update
